    ...
    >
      <div style={{ display: "grid", gap: "18px" }}>
        <div style={mutedPanelStyle}>
          Approved participant partners now live under partner accounts. Legacy scheduling participants still remain on
          the Participants page, and linked partner-managed participants appear there as read-only scheduling records.
        </div>
