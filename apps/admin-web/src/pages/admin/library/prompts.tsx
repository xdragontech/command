...
export default function PromptLibraryPage({
  ...
  return (
    ...
    >
      ...
      <AdminCard
        title="Categories"
        description="Prompt categories are currently subject to global-name uniqueness across the install because of the existing schema. The UI now makes that limitation explicit instead of failing opaquely."
        actions={
