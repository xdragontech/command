...
import { listScheduleOccurrenceVisibilitySummaries } from "@command/core-scheduling";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const summaries = await listScheduleOccurrenceVisibilitySummaries({
    ...
    const message = typeof error?.message === "string" ? error.message : "Failed to load occurrence visibility";
